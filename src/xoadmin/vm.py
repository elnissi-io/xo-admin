...
class VMManagement:
    ...
    async def __init__(self, api: XOAPI) -> None:
        self.api = api
    ...
    async def create_vm_from_template(self, template_id: str, name: str, description: str = "") -> Dict[str, Any]:
        ...
        vm_data = {"template": template_id, "name_label": name, "name_description": description}
